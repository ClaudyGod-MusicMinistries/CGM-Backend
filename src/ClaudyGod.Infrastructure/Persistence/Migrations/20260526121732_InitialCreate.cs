        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AppleUrl = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    YoutubeUrl = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    DeezerUrl = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrgType = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    EventType = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    EventDetails = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LocationAddress1 = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    LocationAddress2 = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    ...
                    LocationZipCode = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
                    LocationCountry = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    StartDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    EndDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    FlyerImagePath = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SlipFilePath = table.Column<string>(type: "text", nullable: false),
                    SlipContentType = table.Column<string>(type: "text", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NigerianBankTransfers", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ZellePayments", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AttendeeFirstName = table.Column<string>(type: "text", nullable: false),
                    AttendeeLastName = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BlogTagId = table.Column<Guid>(type: "uuid", nullable: false),
                    BlogTagId1 = table.Column<Guid>(type: "uuid", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.BlogTagId1,
                        principalTable: "BlogTags",
                        principalColumn: "Id");
                });

            migrationBuilder.CreateIndex(
                name: "IX_Albums_IsPublished_SortOrder",
                table: "Albums",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reels_Category",
                table: "Reels",
                column: "Category");

            migrationBuilder.CreateIndex(
                name: "IX_Reels_Category_IsPublished_SortOrder",
                table: "Reels",
                columns: new[] { "Category", "IsPublished", "SortOrder" });
