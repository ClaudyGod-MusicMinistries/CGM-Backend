...
namespace ClaudyGod.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260729113750_NormalizeBookingCountryCode")]
    partial class NormalizeBookingCountryCode
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ClaudyGod.Domain.Entities.Event", b =>
                {
                    ...
                    b.ToTable("Events", t =>
                        {
                            t.HasCheckConstraint("CK_Events_ReservedCount_WithinCapacity", "\"ReservedCount\" >= 0 AND \"ReservedCount\" <= \"TotalCapacity\"");
            ...
            modelBuilder.Entity("ClaudyGod.Domain.Entities.OutboxMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
